  ...
  return (
    <>
      <ul>
        ...
        <li><a href="#/assignment_4">UI Design 04</a></li>
        <li><a href="#/assignment_5">UI Design 05</a></li>
        <li><a href="#/assignment_6">UI Design 06</a></li>
        <li><a href="#/assignment_7">Dino run</a></li>
      </ul>
    </>
  );
}
